    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-primary pt-32 pb-24 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="/images/ug-programmes.jpg" className="w-full h-full object-cover" alt="BBA Background" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-12">
                The BBA programme at JG University is designed to create "{data.tagline}". Our curriculum is built on NEP 2020 foundations, emphasizing immersive learning and industry readiness through real-world projects and mentorship.
              </p>
