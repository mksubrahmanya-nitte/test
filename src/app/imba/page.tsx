...
export default function IMBAPage() {
  const data = {
    title: "Integrated MBA",
    tagline: "The Fast Track to Leadership",
    duration: "5 Years",
    fees: "₹ 42,000/- per semester",
    eligibility: "10+2 with 45% (Open) / 40% (Reserved)",
    specializations: ["Integrated Management", "Digital Business", "Global Finance", "HR Strategy"],
    highlights: [
      "Seamless transition from UG to PG in a single 5-year path",
      "Focus on early professional development",
      "Internships starting from Year 2",
      "Capstone research project in the final year"
    ],
    exitOptions: [
      { year: "3 Years", award: "BBA Degree" },
      { year: "5 Years", award: "MBA Degree" }
    ]
  };
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-primary pt-32 pb-24 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="/images/ug-programmes.jpg" className="w-full h-full object-cover" alt="IMBA Background" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-black text-gray-900 mb-8">Integrated Excellence</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-12">
                The Integrated MBA at JG University offers a holistic 5-year journey from foundational management concepts to advanced strategic leadership. It is designed for students who are committed to a career in management right from the start.
              </p>
              ...
              {/* Specializations */}
              <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Briefcase size={20} className="text-secondary" /> Areas of Focus
              </h3>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 bg-gray-900 rounded-3xl p-8 text-white shadow-2xl">
                ...
                <p className="text-white/60 mb-8 text-sm">Secure your 5-year management path. Register now.</p>
                <Button 
                ...
                <div className="mt-8 pt-8 border-t border-white/10 space-y-4">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold">5-Year Continuous Path</span>
                   </div>
                   <div className="flex items-center gap-3">
                      <Landmark className="text-secondary" size={20} />
                      <span className="text-sm font-bold">Early Industry Entry</span>
                   </div>
                </div>
              </div>
            </div>
