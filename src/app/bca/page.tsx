...
import { CheckCircle2, Info, Briefcase, Globe, Landmark, Code } from 'lucide-react';
...
export default function BCAPage() {
  const data = {
    title: "BCA / Integrated MCA",
    tagline: "Coding the Next Tech Revolution",
    duration: "3 / 5 Years",
    fees: "₹ 38,000/- per semester",
    eligibility: "10+2 with Maths / Stats / CS",
    specializations: ["Software Development", "Cloud Computing", "AI & Data Science", "Web Architecture"],
    highlights: [
      "24/7 access to high-end computing labs",
      "Project-centric learning from Semester 1",
      "Industry certifications embedded in curriculum",
      "Seamless 5-year pathway to MCA"
    ],
    exitOptions: [
      { year: "1 Year", award: "Certificate" },
      { year: "2 Years", award: "Diploma" },
      { year: "3 Years", award: "BCA Degree" },
      { year: "5 Years", award: "MCA Degree" }
    ]
  };
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-primary pt-32 pb-24 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="/images/ug-programmes.jpg" className="w-full h-full object-cover" alt="BCA Background" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-black text-gray-900 mb-8">Computing Excellence</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-12">
                Our BCA and Integrated MCA programmes are tailored for the digital innovators of tomorrow. With a heavy emphasis on hands-on coding, cloud architecture, and AI, we ensure our graduates are ready for the global tech industry.
              </p>
              ...
              {/* Specializations */}
              <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Briefcase size={20} className="text-secondary" /> Tech Specializations
              </h3>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 bg-gray-900 rounded-3xl p-8 text-white shadow-2xl">
                ...
                <p className="text-white/60 mb-8 text-sm">Become a tech architect. Start your journey today.</p>
                <Button 
                ...
                <div className="mt-8 pt-8 border-t border-white/10 space-y-4">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold">24/7 Coding Labs</span>
                   </div>
                   <div className="flex items-center gap-3">
                      <Landmark className="text-secondary" size={20} />
                      <span className="text-sm font-bold">Industry Certifications</span>
                   </div>
                </div>
              </div>
            </div>
